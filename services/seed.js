    ...
    const photographers = [
      {
        ...
        reviews: [{ name: 'Ananya', rating: 5, comment: 'Truly amazing photos and experience!', date: '2024-12-15' }],
      },
      {
        id: 2,
        ...
        reviews: [{ name: 'Priya', rating: 4, comment: 'Very professional and punctual!', date: '2024-10-01' }],
      },
      {
        id: 3,
        name: 'Click Factory',
        ...
        reviews: [{ name: 'Rahul', rating: 5, comment: 'We loved every single moment they captured.', date: '2025-01-22' }],
      },
      {
        id: 4,
        ...
        reviews: [{ name: 'Sneha', rating: 4.5, comment: 'Captured our maternity journey so beautifully.', date: '2024-11-05' }],
      },
      {
        id: 5,
        ...
        reviews: [{ name: 'Vikram', rating: 3.5, comment: 'Decent service, could improve on punctuality.', date: '2024-09-10' }],
      },
    ];
